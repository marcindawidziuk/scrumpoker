...
" placeholder="Username"
            ...
            <div class="mb-5">
              <label class="block text-gray-700 dark:text-gray-100 font-bold mb-2" for="password">
              Room Name
            </label>
...
" placeholder="Room Name"
            ...
            <div class="w-full">
              <button class="w-full bg-indigo-500 text-gray-50 dark:hover:bg-gray-300 dark:bg-gray-50 dark:text-gray-900 font-semibold p-2 rounded" @click="join()">Start Session</button>
            </div>
          </div>
